...
ActiveRecord::Schema.define(version: 2019_11_07_052647) do
  ...
  create_table "departments_sents", id: false, force: :cascade do |t|
    t.bigint "department_id", null: false
    t.bigint "sent_id", null: false
    t.index ["department_id", "sent_id"], name: "index_departments_sents_on_department_id_and_sent_id"
    t.index ["sent_id", "department_id"], name: "index_departments_sents_on_sent_id_and_department_id"
  end
